...
Check out the [contributing guide](https://github.com/alexandernanberg/horizon-theme-vscode/blob/HEAD/CONTRIBUTING.md) to learn how you can report issues and help make changes.

Always be sure to follow the [Code of Conduct](https://github.com/alexandernanberg/horizon-theme-vscode/blob/HEAD/CODE_OF_CONDUCT.md).

## License

[MIT](https://github.com/alexandernanberg/horizon-theme-vscode/blob/HEAD/LICENSE) © [Jonathan Olaleye](https://github.com/jolaleye)
