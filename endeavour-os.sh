...
# Install with yay
yay --noconfirm -S python git github-cli zsh python-pipx chromium spotify-launcher lib32-mesa vulkan-radeon lib32-vulkan-radeon vulkan-icd-loader lib32-vulkan-icd-loader code python-pip yarn sassc
yay --noconfirm -S brainworkshop-git nvm kitty

mkdir /home/$USER/.config/Code/User
cp settings.json /home/$USER/.config/User
